...
from mamba_ssm_local.ops.triton.layer_norm import _layer_norm_fwd
...
def selective_scan_fn(u, delta, A, B, C, D=None, z=None, delta_bias=None, delta_softplus=False,
    ...
    if _has_selective_scan_cuda:
        ...
        # Fallback to the pure-PyTorch reference implementation (slower but functional).
        if return_last_state:
            return selective_scan_ref(u, delta, A, B, C, D, z, delta_bias, delta_softplus, return_last_state)
        else:
            return selective_scan_ref(u, delta, A, B, C, D, z, delta_bias, delta_softplus)
